...
export default function App() {
  ...
  const availableModes = [
    ...
    { id: 'romaji-reading', label: 'Romaji → Reading', type: 'Production (Write)' },
  ];
  ...
  const filteredVocab = useVocabulary(selectedLesson);
      ...
      <div className="w-full max-w-5xl flex flex-col justify-center h-full">
        ...
        <div className="mb-12 text-center md:text-left flex flex-col md:flex-row md:items-end justify-between">
          ...
          <button 
            ...
            disabled={activeModes.length === 0 || filteredVocab.length === 0}
            className="hidden md:flex py-4 px-10 mt-6 md:mt-0 bg-slate-800 text-white rounded-2xl font-medium tracking-wide items-center justify-center gap-2 hover:bg-slate-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md text-lg"
          >
            Start Session <ChevronRight size={24} />
          </button>
        </div>
        ...
        <div className="mt-16 text-center text-xs font-medium text-slate-400 tracking-wide uppercase">
